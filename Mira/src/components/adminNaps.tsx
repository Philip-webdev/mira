...
import NapsLogo from "@/assets/ALPHA TEAM 20230603_181509.jpg"
...
const NapsDashboard = () => {
  ...
  useEffect(() =>{
    setSubmitted(true);
      const recentTransactions = async () => {
        const response = await fetch('https://Mira-backend-main.onrender.com/api/admin/dashboard/PHS');
  ...
  return (
    <DashboardLayout titile="Naps Dashboard" variant="Naps">
      {submitted && (
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <div className="absolute bottom-6 left-6 z-10 text-white">
                      <h2 className="text-2xl font-bold">National Association of Physics Students (NAPS)</h2>
