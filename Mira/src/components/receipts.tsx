...
import { apiGet } from "@/lib/api";
 ...
 function  Receipt () {
  ...
  const statref = searchParams.get('status');
...
<br/>
      ...
      <div className="mb-4">
        ...
        <div className="grid grid-cols-2 gap-4 text-xs">
          ...
          <div>
            <div className="text-receipt-text text-black">College: {payeData.collegeName || "None"}</div>
...
<br/>
      ...
      <div className="mb-4 bg-gray-100">
        <table className="w-full text-xs">
          ...
          <td className=" py-4 px-10 bg-gray-200 text-receipt-text text-black">{ref}</td>
