...
const CptDashboard = () => {
 ...
 const stats = [
  ...
  const recentTransactions = async () => {
    const response = await fetch('https://Mira-backend-main.onrender.com/api/admin/dashboard/CPT');
...
const Transactions = async () => {
 ...
 useEffect(() => {
  ...
  return (
    <DashboardLayout titile="cpt Dashboard" variant="cpt">
      {submitted && (
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <div className="absolute bottom-6 left-6 z-10 text-white">
                      <h2 className="text-2xl font-bold">Crop Protection (CPT)</h2>
