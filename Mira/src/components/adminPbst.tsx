...
const PbstDashboard = () => {
  ...
  const recentTransactions = async () => {
    const response = await fetch('https://Mira-backend-main.onrender.com/api/admin/dashboard/PBST');
  ...
  return (
    <DashboardLayout titile="pbst Dashboard" variant="pbst">
      {submitted && (
      ...
      <div className="space-y-8">
                <div className="space-y-2">
                   {/* Welcome Section */}
                          ...
                          <div 
                    style={{ 
                      backgroundImage: 'url("/WhatsApp Image 2025-09-21 at 21.12.55_182351e3.jpg")', 
                  ...
                  >
                    ...
                    <div className="absolute bottom-6 left-6 z-10 text-white">
                      <h2 className="text-2xl font-bold">Plant Breeding and Seed Technology (pbst)</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2">
          {stats.map((stat, index) => (
            <Card key={index} className="bg-card/50 backdrop-blur border-pbst/30 h-auto w-auto ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="bg-card/50 backdrop-blur border-pbst/30">
            <CardHeader>
              <CardTitle className="text-foreground flex items-center">
                <Clock className="w-5 h-5 mr-2 text-pbst" />
                Recent Transactions
              </CardTitle>
            </CardHeader>
        ...
        <Card className="bg-card/50 backdrop-blur border-pbst/30">
          <CardHeader>
            <CardTitle className="text-foreground flex items-center">
              <CreditCard className="w-5 h-5 mr-2 text-pbst" />
              All User Payments
            </CardTitle>
          </CardHeader>
          <CardContent>
