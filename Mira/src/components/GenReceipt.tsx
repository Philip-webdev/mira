...
import {QRCodeCanvas} from 'qrcode.react';
 ...
 function  GenReceipt () {
  ...
  const fourefNumbers = Array.from({ length: 4 }, () => Math.floor(Math.random() * 10));
  const fourecNumbers = Array.from({ length: 4 }, () => Math.floor(Math.random() * 10));

  const receipts =[
      {
          collegeName: "College of Physical Sciences (COLPHYS)",
          dateOfPayment:  "2025-12-02T12:00:00Z",
          department: "None",
          email: "",
          fresherLevel: "",
          fullname: "Olojede Abisola Damilola",
          isdepartmentPayment: true,
          level: "400",
          mainLevel: "Staylite",
          matricNumber: "20223814",
          paymentStatus: "Successful",
          reference: `KP-20223814-${fourefNumbers.join('')}`,
          amount: "4000",
          receiptNo: `KP/COLPHYS/20223814/${fourecNumbers.join('')}`
      ...
      },
       {
          ...
          email: "",
          fresherLevel: "",
          fullname: "Abdulazeez Ridwan Olamilekan",
          isdepartmentPayment: true,
          level: "300",
          mainLevel: "Staylite",
          matricNumber: "20233397",
          paymentStatus: "Successful",
          reference: `KP-20233397-${fourefNumbers.join('')}`,
          amount: "4000",
          receiptNo: `KP/COLPHYS/20233397/${fourecNumbers.join('')}`
      ...
      },
       {
          ...
          email: "",
          fresherLevel: "",
          fullname: "Ajayi Alice Motunrayo",
          isdepartmentPayment: true,
          level: "200",
          mainLevel: "Staylite",
          matricNumber: " 20243923",
          paymentStatus: "Successful",
          reference: `KP-20243923-${fourefNumbers.join('')}`,
          amount: "4000",
          receiptNo: `KP/COLPHYS/20243923/${fourecNumbers.join('')}`
      ...
      },
       {
          ...
          email: "",
          fresherLevel: "",
          fullname: "Bankole Israel Olamilekan",
          isdepartmentPayment: true,
          level: "200",
          mainLevel: "Staylite",
          matricNumber: "20243942",
          paymentStatus: "Successful",
          reference: `KP-20243942-${fourefNumbers.join('')}`,
          amount: "4000",
          receiptNo: `KP/COLPHYS/20243942/${fourecNumbers.join('')}`
      ...
      },
       {
          ...
          email: "",
          fresherLevel: "",
          fullname: "Akanji Olutade Akorede",
          isdepartmentPayment: true,
          level: "400",
          mainLevel: "Staylite",
          matricNumber: "20223748",
          paymentStatus: "Successful",
          reference: `KP-20223748-${fourefNumbers.join('')}`,
          amount: "4000",
          receiptNo: `KP/COLPHYS/20223748/${fourecNumbers.join('')}`
      ...
      },
       {
          ...
          email: "",
          fresherLevel: "",
          fullname: "Abhulimhen Mercy Osatofo",
          isdepartmentPayment: true,
          level: "400",
          mainLevel: "Staylite",
          matricNumber: "20223716",
          paymentStatus: "Successful",
          reference: `KP-20223716-${fourefNumbers.join('')}`,
          amount: "4000",
          receiptNo: `KP/COLPHYS/20223716/${fourecNumbers.join('')}`
      ...
      },
       {
          ...
          email: "",
          fresherLevel: "",
          fullname: "Lebile Oriade Kenneth",
          isdepartmentPayment: true,
          level: "200",
          mainLevel: "Staylite",
          matricNumber: "20243967",
          paymentStatus: "Successful",
          reference: `KP-20243967-${fourefNumbers.join('')}`,
          amount: "4000",
          receiptNo: `KP/COLPHYS/20243967/${fourecNumbers.join('')}`
      ...
      },
       {
          ...
          email: "",
          fresherLevel: "",
          fullname: "Olabode Goodness",
          isdepartmentPayment: true,
          level: "400",
          mainLevel: "Staylite",
          matricNumber: "20223807",
          paymentStatus: "Successful",
          reference: `KP-20223807-${fourefNumbers.join('')}`,
          amount: "4000",
          receiptNo: `KP/COLPHYS/20223807/${fourecNumbers.join('')}`
      ...
      },
       {
          ...
          email: "",
          fresherLevel: "",
          fullname: "Adetoye Martins Adewale",
          isdepartmentPayment: true,
          level: "200",
          mainLevel: "Staylite",
          matricNumber: "20243911",
          paymentStatus: "Successful",
          reference: `KP-20243911-${fourefNumbers.join('')}`,
          amount: "4000",
          receiptNo: `KP/COLPHYS/20243911/${fourecNumbers.join('')}`
      ...
      },
       {
          ...
          email: "",
          fresherLevel: "",
          fullname: "Oyenola Philip Shinaayomi",
          isdepartmentPayment: true,
          level: "400",
          mainLevel: "Staylite",
          matricNumber: "20223831",
          paymentStatus: "Successful",
          reference: `KP-20223831-${fourefNumbers.join('')}`,
          amount: "4000",
          receiptNo: `KP/COLPHYS/20223831/${fourecNumbers.join('')}`
      ...
      },
       {
          ...
          email: "",
          fresherLevel: "",
          fullname: "Adegbenro Ayomide",
          isdepartmentPayment: true,
          level: "200",
          mainLevel: "Staylite",
          matricNumber: "20243904",
          paymentStatus: "Successful",
          reference: `KP-20243904-${fourefNumbers.join('')}`,
          amount: "4000",
          receiptNo: `KP/COLPHYS/20243904/${fourecNumbers.join('')}`
