...
import { GraduationCap, DollarSign, CreditCard, TrendingUp, Users, AlertCircle, Clock, Download, FileText, Search } from "lucide-react";
...
useEffect(() => {
  setSubmitted(true)
    ...
    const response = await fetch('https://Mira-backend-main.onrender.com/api/admin/dashboard/GEO');
 ...
 useEffect(() => {
  ...
  return (
    <DashboardLayout titile="Geo Dashboard" variant="Geo">
      {submitted && (
      ...
      <div className="space-y-8">
               ...
               <div className="space-y-2">
                  {/* Welcome Section */}
                         ...
                         <div 
                   style={{ 
                     backgroundImage: 'url("/WhatsApp Image 2025-09-18 at 15.47.19_2301f853.jpg")', 
                 ...
                 >
                   ...
                   <div className="absolute bottom-6 left-6 z-10 text-white">
                     <h2 className="text-2xl font-bold">Geology (GEO)</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2">
          {stats.map((stat, index) => (
            <Card key={index} className="bg-card/50 backdrop-blur border-Geo/30">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="bg-card/50 backdrop-blur border-Geo/30">
          <CardHeader>
            <CardTitle className="text-foreground flex items-center">
              <CreditCard className="w-5 h-5 mr-2 text-Geo" />
              All User Payments
            </CardTitle>
          </CardHeader>
          <CardContent>
