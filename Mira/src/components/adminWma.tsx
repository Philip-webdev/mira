...
import { GraduationCap, Coins, DollarSign, CreditCard, TrendingUp, Users, AlertCircle, Clock, Download,Megaphone, FileText, Search} from "lucide-react";
...
const WmaDashboard = () => {
 ...
 const stats = [
  ...
  useEffect(() => {
    ...
    const response = await fetch('https://Mira-backend-main.onrender.com/api/admin/dashboard/WMA');
  ...
  return (
    <DashboardLayout titile="wma Dashboard" variant="wma">
      {submitted && (
        ...
        <div className="space-y-8">
                <div className="space-y-2">
                   {/* Welcome Section */}
                          ...
                          <div 
                    style={{ 
                      backgroundImage: 'url("https://i.imgur.com/Mq6aWRG.jpeg")', 
                  ...
                  >
                    ...
                    <div className="absolute bottom-6 left-6 z-10 text-white">
                      <h2 className="text-2xl font-bold">Water Resources Management & Agricultural Meteorology (WMA)</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2">
          {stats.map((stat, index) => (
            <Card key={index} className="bg-card/50 backdrop-blur border-wma/30 h-auto w-auto ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="bg-card/50 backdrop-blur border-wma/30">
            <CardHeader>
              <CardTitle className="text-foreground flex items-center">
                <Clock className="w-5 h-5 mr-2 text-wma" />
                Recent Transactions
              </CardTitle>
            </CardHeader>
        ...
        <Card className="bg-card/50 backdrop-blur border-wma/30">
          <CardHeader>
            <CardTitle className="text-foreground flex items-center">
              <CreditCard className="w-5 h-5 mr-2 text-wma" />
              All User Payments
            </CardTitle>
          </CardHeader>
          <CardContent>
