...
import FossuLogo from "@/assets/WhatsApp Image 2025-11-25 at 10.05.09 AM.jpeg"

const FossuDashboard = () => {
  ...
  useEffect(() =>{
    setSubmitted(true);
      const recentTransactions = async () => {
        const response = await fetch('https://Mira-backend-main.onrender.com/api/admin/dashboard/FOSSU');
  ...
  return (
    <DashboardLayout titile="Fossu Dashboard" variant="FOSSU">
      {submitted && (
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <div className="absolute bottom-6 left-6 z-10 text-white">
                      <h2 className="text-2xl font-bold">Federation of Oyo State Students Union (FOSSU)</h2>
