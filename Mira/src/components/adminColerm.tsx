...
const colermDashboard = () => {
  ...
  useEffect(() =>{
    setSubmitted(true);
      const recentTransactions = async () => {
        const response = await fetch('https://Mira-backend-main.onrender.com/api/admin/dashboard/COLERM');
  ...
  return (
    <DashboardLayout titile="colerm Dashboard" variant="colerm">
      {submitted && (
      ...
      <div className="space-y-8">
                <div className="space-y-2">
                   {/* Welcome Section */}
                          ...
                          <div 
                    style={{ 
                      backgroundImage: 'url("/WhatsApp Image 2025-09-14 at 21.44.11_eebaeded.jpg")', 
                  ...
                  >
                    ...
                    <div className="absolute bottom-6 left-6 z-10 text-white">
                      <h2 className="text-2xl font-bold">College of Environmental Resources Management (COLERM)</h2>
...
export default colermDashboard;