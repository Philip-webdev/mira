...
import { GraduationCap, Coins, CreditCard, TrendingUp, Users, AlertCircle, Clock, Download, FileText, DollarSign, Search} from "lucide-react";
...
useEffect(() => {
  ...
  const recentTransactions = async () => {
    const response = await fetch('https://Mira-backend-main.onrender.com/api/admin/dashboard/Fishery');
...
const Transactions = async () => {
 ...
 useEffect(() => {
  ...
  return (
    <DashboardLayout titile="Aqua Dashboard" variant="Aqua">
      {submitted && (
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-2">
           {/* Welcome Section */}
                  ...
                  <div 
            style={{ 
              backgroundImage: 'url("https://i.imgur.com/GLqKucy.jpeg")', 
          ...
          >
            ...
            <div className="absolute bottom-6 left-6 z-10 text-white">
              <h2 className="text-2xl font-bold">Aquaculture & Fisheries Management (Fishery)</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2">
          {stats.map((stat, index) => (
            <Card key={index} className="bg-card/50 backdrop-blur border-Aqua/30">
        ...
        <Card className="bg-card/50 backdrop-blur border-Aqua/30">
          <CardHeader>
            <CardTitle className="text-foreground flex items-center">
              <CreditCard className="w-5 h-5 mr-2 text-Aqua" />
              All User Payments
            </CardTitle>
          </CardHeader>
          <CardContent>
