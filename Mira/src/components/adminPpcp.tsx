...
useEffect(() => {
  ...
  const recentTransactions = async () => {
    const response = await fetch('https://Mira-backend-main.onrender.com/api/admin/dashboard/PPCP');
...
useEffect(() => {
  ...
  return (
    <DashboardLayout titile="ppcp Dashboard" variant="ppcp">
      {submitted && (
      ...
      <div className="space-y-8">
                <div className="space-y-2">
                   {/* Welcome Section */}
                          ...
                          <div 
                    style={{ 
                      backgroundImage: 'url("/WhatsApp Image 2025-09-19 at 08.43.21_d1c86c59.jpg")', 
                  ...
                  >
                    ...
                    <div className="absolute bottom-6 left-6 z-10 text-white">
                      <h2 className="text-2xl font-bold">Plant Physiology and Crop Production (PPCP)</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2">
          {stats.map((stat, index) => (
            <Card key={index} className="bg-card/50 backdrop-blur border-ppcp/30 h-auto w-auto ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="bg-card/50 backdrop-blur border-ppcp/30">
            <CardHeader>
              <CardTitle className="text-foreground flex items-center">
                <Clock className="w-5 h-5 mr-2 text-ppcp" />
                Recent Transactions
              </CardTitle>
            </CardHeader>
        ...
        <Card className="bg-card/50 backdrop-blur border-ppcp/30">
          <CardHeader>
            <CardTitle className="text-foreground flex items-center">
              <CreditCard className="w-5 h-5 mr-2 text-ppcp" />
              All User Payments
            </CardTitle>
          </CardHeader>
          <CardContent>
