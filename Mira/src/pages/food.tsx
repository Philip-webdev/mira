    ...
    <div className="min-h-screen bg-[#180b28] px-6 py-8 text-white" style={{ fontFamily: "Sora, sans-serif" }}>
      ...
      <div className="mx-auto flex min-h-[78vh] max-w-md flex-col items-center justify-center text-center">
        <div className="mb-6 inline-flex h-20 w-20 items-center justify-center rounded-3xl bg-[#5f67ac]/25 ring-1 ring-white/10">
          <Utensils className="h-10 w-10 text-[#d8daf7]" />
        </div>
        <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[#b8bcef]">Mira Food</p>
        <h1 className="mt-3 text-3xl font-bold tracking-tight">Campus meals are coming soon</h1>
        <p className="mt-3 text-sm leading-6 text-white/65">
          We are shaping this into a fast, simple way to discover and pay for food around campus.
        </p>
      </div>
    </div>
  );
